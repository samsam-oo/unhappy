/**
 * English translations for the Unhappy app
 * Values can be:
...
export const en = {
  ...
  settings: {
    ...
    about: 'About',
    aboutFooter:
      "Unhappy Coder is a Codex and Claude Code mobile client. It's fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic. We respectfully acknowledge slopus/happy as the original licensed upstream work.",
    whatsNew: "What's New",
  ...
  settingsAppearance: {
    ...
    showLineNumbersInDiffs: 'Show Line Numbers in Changes',
    showLineNumbersInDiffsDescription: 'Display line numbers in code changes',
    showLineNumbersInToolViews: 'Show Line Numbers in Tool Views',
    showLineNumbersInToolViewsDescription:
      'Display line numbers in tool view changes',
    wrapLinesInDiffs: 'Wrap Lines in Changes',
    wrapLinesInDiffsDescription:
      'Wrap long lines instead of horizontal scrolling in change views',
  ...
  newSession: {
    ...
    noMachinesFound:
      'No machines found. Start a Unhappy session on your computer first.',
  ...
  server: {
    ...
    notValidHappyServer: 'Not a valid Unhappy Server',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied: 'Unhappy Session ID copied to clipboard',
    failedToCopySessionId: 'Failed to copy Unhappy Session ID',
    happySessionId: 'Unhappy Session ID',
    ...
    updateCliInstructions: 'Please run npm install -g unhappy-cli@latest',
  ...
  components: {
    emptyMainScreen: {
      ...
      installCli: 'Install the Unhappy CLI',
      runIt: 'Run it',
  ...
  agentInput: {
    permissionMode: {
      ...
      badgeBypassAllPermissions: 'Bypass',
  ...
  terminal: {
    ...
    terminalRequestDescription:
      'A terminal is requesting to connect to your Unhappy Coder account. This will allow the terminal to send and receive messages securely.',
  ...
  machine: {
    ...
    offlineHelp:
      '• Make sure your computer is online\n• Run `unhappy daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g unhappy-cli@latest`',
    daemon: 'Daemon',
    status: 'Status',
  ...
  finishSession: {
    ...
    commitChangesSubtitle: 'Stage all changes and create a commit',
    ...
    mustCommitBeforePush:
      'You have uncommitted changes. Commit or stash before pushing.',
    nothingToPush: 'No commits to push. Commit your changes first.',
    commitSuccess: 'Commit Created',
    commitSuccessMessage: 'Changes committed successfully.',
    actions: 'Actions',
    mergeInto: ({ branch }: { branch: string }) => `Merge into ${branch}`,
    mergeSubtitle: ({ branch }: { branch: string }) =>
      `Merge this branch into ${branch}`,
