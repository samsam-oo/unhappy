...
export const en = {
  ...
  sessionInfo: {
    ...
    updateCliInstructions: 'Please run npm install -g unhappy-coder@latest',
  ...
  machine: {
    ...
    offlineHelp:
      '• Make sure your computer is online\n• Run `unhappy daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g unhappy-coder@latest`',
    daemon: 'Daemon',
    status: 'Status',
