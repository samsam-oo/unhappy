...
/**
 * Portuguese (Brazilian) translations for the Unhappy app
...
export const pt: TranslationStructure = {
  ...
  settings: {
    ...
    about: 'Sobre',
    aboutFooter:
      'Unhappy Coder é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
    whatsNew: 'Novidades',
  ...
  newSession: {
    ...
    noMachinesFound:
      'Nenhuma máquina encontrada. Inicie uma sessão Unhappy no seu computador primeiro.',
    ...
    worktree: {
      nameLabel: 'Nome do worktree',
      namePlaceholder: 'ex.: swift-island',
      nameHint:
        'Usado tanto para a pasta do worktree quanto para o branch do git.',
  ...
  server: {
    ...
    notValidHappyServer: 'Não é um servidor Unhappy válido',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied:
      'ID da sessão Unhappy copiado para a área de transferência',
    failedToCopySessionId: 'Falha ao copiar ID da sessão Unhappy',
    happySessionId: 'ID da sessão Unhappy',
    ...
    updateCliInstructions:
      'Por favor execute npm install -g unhappy-coder@latest',
  ...
  components: {
    emptyMainScreen: {
      ...
      installCli: 'Instale o Unhappy CLI',
      runIt: 'Execute',
  ...
  terminal: {
    ...
    terminalRequestDescription:
      'Um terminal está solicitando conexão à sua conta Unhappy Coder. Isso permitirá que o terminal envie e receba mensagens com segurança.',
  ...
  machine: {
    ...
    offlineHelp:
      '• Verifique se seu computador está online\n• Execute `unhappy daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g unhappy-coder@latest`',
  ...
  finishSession: {
    ...
    subtitle: 'Mesclar, criar PR ou limpar worktree',
    branchName: 'Branch',
    basePath: 'Repositório base',
    uncommittedWarning: 'Este worktree tem alterações não commitadas',
    commitChanges: 'Fazer commit das alterações',
    commitChangesSubtitle: 'Adicionar tudo ao stage e criar um commit',
    commitMessageTitle: 'Mensagem do commit',
    commitMessagePrompt: 'Digite uma mensagem de commit:',
    commitConfirm: 'Commit',
    commitMessageRequired: 'A mensagem de commit é obrigatória.',
    noChangesToCommit: 'Não há alterações para commitar.',
    mustCommitBeforePush:
      'Você tem alterações não commitadas. Faça commit ou stash antes de enviar (push).',
    nothingToPush:
      'Não há commits para enviar (push). Faça commit das alterações primeiro.',
    commitSuccess: 'Commit criado',
    commitSuccessMessage: 'Alterações commitadas com sucesso.',
    actions: 'Ações',
    mergeInto: ({ branch }: { branch: string }) => `Mesclar em ${branch}`,
    mergeSubtitle: ({ branch }: { branch: string }) =>
      `Mesclar este branch em ${branch}`,
    mergeConfirmTitle: 'Mesclar branch',
    mergeConfirmMessage: ({
      branch,
      target,
    }: {
      branch: string;
      target: string;
    }) => `Mesclar '${branch}' em '${target}'?`,
    merge: 'Mesclar',
    pushAfterMerge: 'Enviar após mesclar',
    mergeSuccess: 'Mesclagem concluída',
    mergeSuccessMessage: 'Branch mesclado com sucesso.',
    mergeAndPushSuccessMessage: 'Branch mesclado e enviado com sucesso.',
    createPR: 'Criar Pull Request',
    createPRSubtitle: 'Enviar branch e abrir um PR no GitHub',
    prCreated: 'Pull Request criado',
    copyUrl: 'Copiar URL',
    dangerZone: 'Zona de perigo',
    deleteWorktree: 'Excluir worktree',
    deleteWorktreeSubtitle: 'Remover worktree, excluir branch e limpar',
    deleteConfirmTitle: 'Excluir worktree',
    deleteConfirmMessage: ({ branch }: { branch: string }) =>
      `O worktree '${branch}' será removido e o branch excluído. Esta ação não pode ser desfeita.`,
    deleteSuccess: 'Worktree excluído',
    deleteSuccessMessage: 'O worktree e o branch foram removidos.',
    notAWorktree: 'Esta sessão não é uma sessão de worktree.',
    resolvingBranch: 'Resolvendo branch principal...',
  },
  ...
  workspaceExplorer: {
    ...
    deleteWorkspaceConfirm: 'Tem certeza de que deseja excluir este espaço de trabalho? Todas as sessões serão arquivadas.',
    deleteWorktree: 'Excluir worktree',
    deleteWorktreeConfirm: 'Tem certeza de que deseja excluir este worktree? Todas as sessões serão arquivadas.',
    archiveSessionConfirm: 'Tem certeza de que deseja arquivar esta sessão?',
  },
} as const;
