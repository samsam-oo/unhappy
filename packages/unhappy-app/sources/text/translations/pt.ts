...
export const pt: TranslationStructure = {
    ...
    newSession: {
        ...
        worktree: {
            ...
            nameHint: 'Usado tanto para a pasta do worktree quanto para o branch do git.',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor execute npm install -g unhappy-coder@latest',
    ...
    finishSession: {
        ...
        mustCommitBeforePush: 'Você tem alterações não commitadas. Faça commit ou stash antes de enviar (push).',
        nothingToPush: 'Não há commits para enviar (push). Faça commit das alterações primeiro.',
        ...
        mergeSubtitle: ({ branch }: { branch: string }) => `Mesclar este branch em ${branch}`,
