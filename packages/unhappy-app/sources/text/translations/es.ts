...
export const es: TranslationStructure = {
    ...
    newSession: {
        ...
        worktree: {
            ...
            nameHint: 'Se usa tanto para la carpeta del worktree como para la rama de git.',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g unhappy-coder@latest',
    ...
    finishSession: {
        ...
        mustCommitBeforePush: 'Tienes cambios sin confirmar. Haz commit o stash antes de hacer push.',
        nothingToPush: 'No hay commits para hacer push. Haz commit de tus cambios primero.',
