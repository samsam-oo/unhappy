...
/**
 * Spanish translations for the Unhappy app
...
export const es: TranslationStructure = {
  ...
  settings: {
    ...
    about: 'Acerca de',
    aboutFooter:
      'Unhappy Coder es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
    whatsNew: 'Novedades',
  ...
  newSession: {
    ...
    noMachinesFound:
      'No se encontraron máquinas. Inicia una sesión de Unhappy en tu computadora primero.',
    ...
    worktree: {
      nameLabel: 'Nombre del worktree',
      namePlaceholder: 'p. ej. swift-island',
      nameHint:
        'Se usa tanto para la carpeta del worktree como para la rama de git.',
  ...
  server: {
    ...
    notValidHappyServer: 'No es un servidor Unhappy válido',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied: 'ID de sesión de Unhappy copiado al portapapeles',
    failedToCopySessionId: 'Falló al copiar ID de sesión de Unhappy',
    happySessionId: 'ID de sesión de Unhappy',
    ...
    happyHome: 'Directorio de Unhappy',
    ...
    updateCliInstructions:
      'Por favor ejecute npm install -g unhappy-cli@latest',
  ...
  components: {
    emptyMainScreen: {
      ...
      installCli: 'Instale el Unhappy CLI',
      runIt: 'Ejecútelo',
  ...
  terminal: {
    ...
    terminalRequestDescription:
      'Un terminal está solicitando conectarse a tu cuenta de Unhappy Coder. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
  ...
  welcome: {
    ...
    featureEncrypted: 'Cifrado E2E',
    featureCrossPlatform: 'Multiplataforma',
    featureInstantSync: 'Sincronización instantánea',
  },
  ...
  machine: {
    ...
    offlineHelp:
      '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `unhappy daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g unhappy-cli@latest`',
  ...
  finishSession: {
    ...
    commitChanges: 'Hacer commit de cambios',
    commitChangesSubtitle: 'Preparar todos los cambios y crear un commit',
    commitMessageTitle: 'Mensaje de commit',
    commitMessagePrompt: 'Ingresa un mensaje de commit:',
    commitConfirm: 'Commit',
    commitMessageRequired: 'Se requiere un mensaje de commit.',
    noChangesToCommit: 'No hay cambios para confirmar.',
    mustCommitBeforePush:
      'Tienes cambios sin confirmar. Haz commit o stash antes de hacer push.',
    nothingToPush:
      'No hay commits para hacer push. Haz commit de tus cambios primero.',
    commitSuccess: 'Commit creado',
    commitSuccessMessage: 'Los cambios se confirmaron correctamente.',
    actions: 'Acciones',
    mergeInto: ({ branch }: { branch: string }) => `Fusionar en ${branch}`,
    mergeSubtitle: ({ branch }: { branch: string }) =>
      `Fusionar esta rama en ${branch}`,
