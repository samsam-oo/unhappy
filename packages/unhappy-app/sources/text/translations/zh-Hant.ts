/**
 * Chinese (Traditional) translations for the Unhappy app
 * Values can be:
...
export const zhHant: TranslationStructure = {
  ...
  settings: {
    ...
    about: '關於',
    aboutFooter:
      'Unhappy Coder 是一個 Codex 和 Claude Code 行動用戶端。它採用端對端加密，您的帳戶僅儲存在本機裝置上。與 Anthropic 無關聯。',
    whatsNew: '更新日誌',
  ...
  newSession: {
    ...
    title: '啟動新工作階段',
    noMachinesFound: '未找到裝置。請先在您的電腦上啟動 Unhappy 工作階段。',
  ...
  server: {
    ...
    notValidHappyServer: '不是有效的 Unhappy 伺服器',
    changeServer: '更改伺服器',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied: 'Unhappy 工作階段 ID 已複製到剪貼簿',
    failedToCopySessionId: '複製 Unhappy 工作階段 ID 失敗',
    happySessionId: 'Unhappy 工作階段 ID',
  ...
  terminal: {
    ...
    terminalRequestDescription:
      '有終端正在請求連線到您的 Unhappy Coder 帳戶。這將允許終端安全地傳送和接收訊息。',
  ...
  finishSession: {
    ...
    commitChanges: '提交變更',
    commitChangesSubtitle: '將所有變更加入暫存並建立一次提交',
    commitMessageTitle: '提交訊息',
    commitMessagePrompt: '請輸入提交訊息：',
    commitConfirm: '提交',
    commitMessageRequired: '提交訊息為必填。',
    noChangesToCommit: '沒有可提交的變更。',
    mustCommitBeforePush: '有未提交的變更。推送前請先提交或暫存。',
    nothingToPush: '沒有可推送的提交。請先提交變更。',
    commitSuccess: '提交已建立',
    commitSuccessMessage: '變更已成功提交。',
    actions: '操作',
