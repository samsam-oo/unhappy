...
export const ko: TranslationStructure = {
  ...
  settingsAppearance: {
    ...
    showLineNumbersInDiffs: '변경사항에 줄 번호 표시',
    showLineNumbersInDiffsDescription: '코드 변경사항에 줄 번호를 표시',
    showLineNumbersInToolViews: '도구 뷰에 줄 번호 표시',
    showLineNumbersInToolViewsDescription: '도구 뷰 변경사항에 줄 번호를 표시',
    wrapLinesInDiffs: '변경사항 줄 바꿈',
    wrapLinesInDiffsDescription: '변경사항 뷰에서 긴 줄을 가로 스크롤 대신 줄 바꿈',
    avatarStyle: '아바타 스타일',
  ...
  errors: {
    ...
    machineOffline: '머신이 오프라인입니다',
    failedToListDirectory: '디렉터리 목록을 가져오지 못했습니다',
    failedToParseDirectoryList: '디렉터리 목록 파싱에 실패했습니다',
    tryAgain: '다시 시도해 주세요',
  ...
  agentInput: {
    ...
    codexModel: {
      title: 'CODEX 모델',
      gpt5CodexLow: 'gpt-5-codex 저용량',
      gpt5CodexMedium: 'gpt-5-codex 중간',
      gpt5CodexHigh: 'gpt-5-codex 고성능',
      gpt5Minimal: 'GPT-5 최소',
      gpt5Low: 'GPT-5 저용량',
      gpt5Medium: 'GPT-5 중간',
      gpt5High: 'GPT-5 고성능',
    },
  ...
  welcome: {
    ...
    featureEncrypted: 'E2E 암호화',
    featureCrossPlatform: '크로스 플랫폼',
    featureInstantSync: '즉시 동기화',
  },
