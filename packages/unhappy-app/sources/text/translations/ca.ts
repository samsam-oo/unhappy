...
/**
 * Catalan translations for the Unhappy app
...
export const ca: TranslationStructure = {
  ...
  settings: {
    ...
    about: 'Quant a',
    aboutFooter:
      'Unhappy Coder és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
    whatsNew: 'Novetats',
  ...
  errors: {
    ...
    failedToListDirectory: 'No s\'ha pogut llistar el directori',
    failedToParseDirectoryList: "No s'ha pogut analitzar la llista del directori",
  ...
  newSession: {
    ...
    noMachinesFound:
      "No s'han trobat màquines. Inicia una sessió de Unhappy al teu ordinador primer.",
    ...
    worktree: {
      ...
      nameHint:
        "S'utilitza tant per a la carpeta del worktree com per a la branca git.",
  ...
  server: {
    ...
    notValidHappyServer: 'No és un servidor Unhappy vàlid',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied: 'ID de la sessió de Unhappy copiat al porta-retalls',
    failedToCopySessionId: "Ha fallat copiar l'ID de la sessió de Unhappy",
    happySessionId: 'ID de la sessió de Unhappy',
    ...
    happyHome: 'Directori de Unhappy',
  ...
  components: {
    emptyMainScreen: {
      ...
      installCli: 'Instal·la el Unhappy CLI',
      runIt: "Executa'l",
  ...
  agentInput: {
    ...
    codexPermissionMode: {
      ...
      readOnly: 'Mode de només lectura',
      safeYolo: 'Safe YOLO',
      yolo: 'YOLO',
      badgeReadOnly: 'Mode de només lectura',
    ...
    reasoningEffort: {
      ...
      high: 'Alt',
      max: 'Màxim',
      label: "Esforç de raonament",
      accessibilityHint: ({ current }: { current: string }) =>
        `Nivell d'esforç. Actual: ${current}.`,
    },
    context: {
  ...
  terminal: {
    ...
    terminalRequestDescription:
      'Un terminal està sol·licitant connectar-se al teu compte de Unhappy Coder. Això permetrà al terminal enviar i rebre missatges de forma segura.',
  ...
  welcome: {
    ...
    featureEncrypted: 'Xifratge E2E',
    featureCrossPlatform: 'Multiplataforma',
    featureInstantSync: 'Sincronització instantània',
  },
  ...
  finishSession: {
    ...
    subtitle: 'Fusionar, crear PR o netejar worktree',
    branchName: 'Branca',
    basePath: 'Repositori base',
    uncommittedWarning: 'Aquest worktree té canvis sense confirmar',
    commitChanges: 'Fer commit dels canvis',
    commitChangesSubtitle: 'Preparar tots els canvis i crear un commit',
    commitMessageTitle: 'Missatge de commit',
    commitMessagePrompt: 'Introdueix un missatge de commit:',
    commitConfirm: 'Commit',
    commitMessageRequired: 'Cal un missatge de commit.',
    noChangesToCommit: 'No hi ha canvis per fer commit.',
    mustCommitBeforePush:
      'Tens canvis sense confirmar. Fes commit o stash abans de fer push.',
    nothingToPush:
      'No hi ha commits per fer push. Fes commit dels canvis primer.',
    commitSuccess: 'Commit creat',
    commitSuccessMessage: 'Els canvis s’han confirmat correctament.',
    actions: 'Accions',
    mergeInto: ({ branch }: { branch: string }) => `Fusionar a ${branch}`,
    mergeSubtitle: ({ branch }: { branch: string }) =>
      `Fusionar aquesta branca a ${branch}`,
    mergeConfirmTitle: 'Fusionar branca',
    mergeConfirmMessage: ({
      branch,
      target,
    }: {
      branch: string;
      target: string;
    }) => `Fusionar '${branch}' a '${target}'?`,
    merge: 'Fusionar',
    pushAfterMerge: 'Enviar després de fusionar',
    mergeSuccess: 'Fusió completada',
    mergeSuccessMessage: "La branca s'ha fusionat correctament.",
    mergeAndPushSuccessMessage:
      "La branca s'ha fusionat i enviat correctament.",
    createPR: 'Crear Pull Request',
    createPRSubtitle: 'Enviar branca i obrir un PR a GitHub',
    prCreated: 'Pull Request creat',
    copyUrl: 'Copiar URL',
    dangerZone: 'Zona de perill',
    deleteWorktree: 'Eliminar worktree',
    deleteWorktreeSubtitle: 'Eliminar worktree, branca i netejar',
    deleteConfirmTitle: 'Eliminar worktree',
    deleteConfirmMessage: ({ branch }: { branch: string }) =>
      `El worktree '${branch}' s'eliminarà juntament amb la branca. Aquesta acció no es pot desfer.`,
    deleteSuccess: 'Worktree eliminat',
    deleteSuccessMessage: "El worktree i la branca s'han eliminat.",
    notAWorktree: 'Aquesta sessió no és una sessió de worktree.',
    resolvingBranch: 'Resolent la branca principal...',
  },
