...
export const ca: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g unhappy-coder@latest',
    ...
    finishSession: {
        ...
        mustCommitBeforePush: 'Tens canvis sense confirmar. Fes commit o stash abans de fer push.',
        nothingToPush: 'No hi ha commits per fer push. Fes commit dels canvis primer.',
        ...
        mergeSubtitle: ({ branch }: { branch: string }) => `Fusionar aquesta branca a ${branch}`,
        ...
        mergeAndPushSuccessMessage: 'La branca s\'ha fusionat i enviat correctament.',
