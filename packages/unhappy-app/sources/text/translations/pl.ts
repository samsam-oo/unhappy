...
/**
 * Polish translations for the Unhappy app
...
export const pl: TranslationStructure = {
  ...
  settings: {
    ...
    about: 'O aplikacji',
    aboutFooter:
      'Unhappy Coder to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
    whatsNew: 'Co nowego',
  ...
  newSession: {
    ...
    noMachinesFound:
      'Nie znaleziono maszyn. Najpierw uruchom sesję Unhappy na swoim komputerze.',
    ...
    worktree: {
      ...
      nameHint:
        'Używana zarówno jako nazwa folderu worktree, jak i gałęzi git.',
  ...
  server: {
    ...
    notValidHappyServer: 'To nie jest prawidłowy serwer Unhappy',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied: 'ID sesji Unhappy skopiowane do schowka',
    failedToCopySessionId: 'Nie udało się skopiować ID sesji Unhappy',
    ...
    happyHome: 'Katalog domowy Unhappy',
    ...
    updateCliInstructions:
      'Proszę uruchomić npm install -g unhappy-coder@latest',
  ...
  components: {
    emptyMainScreen: {
      ...
      installCli: 'Zainstaluj Unhappy CLI',
      runIt: 'Uruchom je',
  ...
  terminal: {
    ...
    terminalRequestDescription:
      'Terminal żąda połączenia z Twoim kontem Unhappy Coder. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
  ...
  machine: {
    ...
    offlineHelp:
      '• Upewnij się, że komputer jest online\n• Uruchom `unhappy daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g unhappy-coder@latest`',
  ...
  finishSession: {
    ...
    commitChangesSubtitle: 'Dodaj wszystko do stage i utwórz commit',
    commitMessageTitle: 'Wiadomość commitu',
    commitMessagePrompt: 'Wpisz wiadomość commitu:',
    commitConfirm: 'Commit',
    commitMessageRequired: 'Wiadomość commitu jest wymagana.',
    noChangesToCommit: 'Brak zmian do zatwierdzenia.',
    mustCommitBeforePush:
      'Masz niezatwierdzone zmiany. Zrób commit lub stash przed push.',
    nothingToPush: 'Brak commitów do wypchnięcia. Najpierw zatwierdź zmiany.',
    commitSuccess: 'Commit utworzony',
    commitSuccessMessage: 'Zmiany zostały pomyślnie zatwierdzone.',
    actions: 'Akcje',
    mergeInto: ({ branch }: { branch: string }) => `Scal do ${branch}`,
    mergeSubtitle: ({ branch }: { branch: string }) =>
      `Scal tę gałąź do ${branch}`,
