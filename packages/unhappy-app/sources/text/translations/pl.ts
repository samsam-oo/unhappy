...
export const pl: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g unhappy-coder@latest',
    ...
    finishSession: {
        ...
        mustCommitBeforePush: 'Masz niezatwierdzone zmiany. Zrób commit lub stash przed push.',
