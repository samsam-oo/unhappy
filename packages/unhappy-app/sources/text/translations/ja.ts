/**
 * Japanese translations for the Unhappy app
 * Values can be:
...
export const ja: TranslationStructure = {
  ...
  finishSession: {
    title: 'セッション終了',
    subtitle: 'マージ、PR作成、またはワークツリーのクリーンアップ',
    branchName: 'ブランチ',
    basePath: 'ベースリポジトリ',
    uncommittedWarning:
      'このワークツリーにはコミットされていない変更があります',
    commitChanges: '変更をコミット',
    commitChangesSubtitle: 'すべてをステージしてコミットを作成',
    commitMessageTitle: 'コミットメッセージ',
    commitMessagePrompt: 'コミットメッセージを入力してください:',
    commitConfirm: 'コミット',
    commitMessageRequired: 'コミットメッセージが必要です。',
    noChangesToCommit: 'コミットする変更がありません。',
    mustCommitBeforePush:
      'コミットされていない変更があります。プッシュ前にコミットまたはstashしてください。',
    nothingToPush:
      'プッシュするコミットがありません。先に変更をコミットしてください。',
    commitSuccess: 'コミット完了',
    commitSuccessMessage: '変更が正常にコミットされました。',
    actions: 'アクション',
    mergeInto: ({ branch }: { branch: string }) => `${branch}にマージ`,
    mergeSubtitle: ({ branch }: { branch: string }) =>
      `このブランチを${branch}にマージ`,
    mergeConfirmTitle: 'ブランチをマージ',
    mergeConfirmMessage: ({
      branch,
      target,
    }: {
      branch: string;
      target: string;
    }) => `'${branch}'を'${target}'にマージしますか？`,
    merge: 'マージ',
    pushAfterMerge: 'マージ後にプッシュ',
    mergeSuccess: 'マージ完了',
    mergeSuccessMessage: 'ブランチのマージが成功しました。',
    mergeAndPushSuccessMessage: 'ブランチのマージとプッシュが成功しました。',
    createPR: 'Pull Requestを作成',
    createPRSubtitle: 'ブランチをプッシュしてGitHubでPRを開く',
    prCreated: 'Pull Requestが作成されました',
    copyUrl: 'URLをコピー',
    dangerZone: '危険ゾーン',
    deleteWorktree: 'ワークツリーを削除',
    deleteWorktreeSubtitle:
      'ワークツリーの削除、ブランチの削除、クリーンアップ',
    deleteConfirmTitle: 'ワークツリーを削除',
    deleteConfirmMessage: ({ branch }: { branch: string }) =>
      `'${branch}'のワークツリーを削除し、ブランチを削除します。この操作は元に戻せません。`,
    deleteSuccess: 'ワークツリー削除完了',
    deleteSuccessMessage: 'ワークツリーとブランチが削除されました。',
    notAWorktree: 'このセッションはワークツリーセッションではありません。',
    resolvingBranch: 'メインブランチを確認中...',
  },
  ...
  settings: {
    ...
    about: 'このアプリについて',
    aboutFooter:
      'Unhappy CoderはCodexとClaude Codeのモバイルクライアントです。完全なエンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
    whatsNew: '新機能',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied:
      'Unhappy Session IDがクリップボードにコピーされました',
    failedToCopySessionId: 'Unhappy Session IDのコピーに失敗しました',
