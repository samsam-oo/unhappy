...
export const ja: TranslationStructure = {
    ...
    finishSession: {
        ...
        branchName: 'ブランチ',
        basePath: 'ベースリポジトリ',
        uncommittedWarning: 'このワークツリーにはコミットされていない変更があります',
        ...
        mustCommitBeforePush: 'コミットされていない変更があります。プッシュ前にコミットまたはstashしてください。',
        nothingToPush: 'プッシュするコミットがありません。先に変更をコミットしてください。',
        commitSuccess: 'コミット完了',
        commitSuccessMessage: '変更が正常にコミットされました。',
        actions: 'アクション',
        mergeInto: ({ branch }: { branch: string }) => `${branch}にマージ`,
        mergeSubtitle: ({ branch }: { branch: string }) => `このブランチを${branch}にマージ`,
        ...
        deleteWorktreeSubtitle: 'ワークツリーの削除、ブランチの削除、クリーンアップ',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'npm install -g unhappy-coder@latest を実行してください',
