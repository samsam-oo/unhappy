...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g unhappy-coder@latest',
    ...
    finishSession: {
        ...
        mustCommitBeforePush: 'Есть незакоммиченные изменения. Сделайте коммит или stash перед push.',
