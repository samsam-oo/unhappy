...
export const it: TranslationStructure = {
    ...
    finishSession: {
        ...
        mustCommitBeforePush: 'Hai modifiche non committate. Committa o fai stash prima di fare push.',
        ...
        mergeSubtitle: ({ branch }: { branch: string }) => `Unisci questo branch in ${branch}`,
        ...
        mergeAndPushSuccessMessage: 'Il branch è stato unito e inviato con successo.',
