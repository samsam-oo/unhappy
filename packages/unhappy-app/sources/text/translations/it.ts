...
/**
 * Italian translations for the Unhappy app
...
export const it: TranslationStructure = {
  ...
  finishSession: {
    ...
    subtitle: 'Unisci, crea PR o pulisci worktree',
    branchName: 'Branch',
    basePath: 'Repository base',
    uncommittedWarning: 'Questo worktree ha modifiche non committate',
    commitChanges: 'Committa modifiche',
    commitChangesSubtitle: 'Aggiungi tutto allo stage e crea un commit',
    commitMessageTitle: 'Messaggio di commit',
    commitMessagePrompt: 'Inserisci un messaggio di commit:',
    commitConfirm: 'Commit',
    commitMessageRequired: 'Il messaggio di commit è obbligatorio.',
    noChangesToCommit: 'Nessuna modifica da committare.',
    mustCommitBeforePush:
      'Hai modifiche non committate. Committa o fai stash prima di fare push.',
    nothingToPush: 'Nessun commit da inviare. Committa prima le modifiche.',
    commitSuccess: 'Commit creato',
    commitSuccessMessage: 'Modifiche committate con successo.',
    actions: 'Azioni',
    mergeInto: ({ branch }: { branch: string }) => `Unisci in ${branch}`,
    mergeSubtitle: ({ branch }: { branch: string }) =>
      `Unisci questo branch in ${branch}`,
    mergeConfirmTitle: 'Unisci branch',
    mergeConfirmMessage: ({
      branch,
      target,
    }: {
      branch: string;
      target: string;
    }) => `Unire '${branch}' in '${target}'?`,
    merge: 'Unisci',
    pushAfterMerge: "Invia dopo l'unione",
    mergeSuccess: 'Unione completata',
    mergeSuccessMessage: 'Il branch è stato unito con successo.',
    mergeAndPushSuccessMessage:
      'Il branch è stato unito e inviato con successo.',
    createPR: 'Crea Pull Request',
    createPRSubtitle: 'Invia il branch e apri un PR su GitHub',
    prCreated: 'Pull Request creata',
    copyUrl: 'Copia URL',
    dangerZone: 'Zona pericolosa',
    deleteWorktree: 'Elimina worktree',
    deleteWorktreeSubtitle: 'Rimuovi worktree, elimina branch e pulisci',
    deleteConfirmTitle: 'Elimina worktree',
    deleteConfirmMessage: ({ branch }: { branch: string }) =>
      `Il worktree '${branch}' verrà rimosso e il branch eliminato. Questa azione non può essere annullata.`,
    deleteSuccess: 'Worktree eliminato',
    deleteSuccessMessage: 'Il worktree e il branch sono stati rimossi.',
    notAWorktree: 'Questa sessione non è una sessione worktree.',
    resolvingBranch: 'Risoluzione del branch principale...',
  },
  ...
  settings: {
    ...
    about: 'Informazioni',
    aboutFooter:
      'Unhappy Coder è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
    whatsNew: 'Novità',
  ...
  newSession: {
    ...
    noMachinesFound:
      'Nessuna macchina trovata. Avvia prima una sessione Unhappy sul tuo computer.',
  ...
  server: {
    ...
    notValidHappyServer: 'Non è un Unhappy Server valido',
  ...
  sessionInfo: {
    ...
    happySessionIdCopied: 'ID sessione Unhappy copiato negli appunti',
    failedToCopySessionId: "Impossibile copiare l'ID sessione Unhappy",
    happySessionId: 'ID sessione Unhappy',
  ...
  components: {
    emptyMainScreen: {
      ...
      installCli: 'Installa la CLI Unhappy',
      runIt: 'Avviala',
  ...
  terminal: {
    ...
    terminalRequestDescription:
      'Un terminale richiede di connettersi al tuo account Unhappy Coder. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
  ...
  workspaceExplorer: {
    ...
    deleteWorkspaceConfirm: 'Sei sicuro di voler eliminare questa area di lavoro? Tutte le sessioni verranno archiviate.',
    deleteWorktree: 'Elimina worktree',
    deleteWorktreeConfirm: 'Sei sicuro di voler eliminare questo worktree? Tutte le sessioni verranno archiviate.',
    archiveSessionConfirm: 'Sei sicuro di voler archiviare questa sessione?',
  },
} as const;
