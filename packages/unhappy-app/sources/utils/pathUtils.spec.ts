...
describe('pathUtils', () => {
    ...
    describe('resolvePath (existing function)', () => {
        ...
        it('should not resolve sibling directory paths that start with metadata path', () => {
            const metadata = {
                path: '/Users/steve/Develop/samsam-oo/unhappy',
                host: 'localhost',
                homeDir: '/Users/steve'
            };
            // This should NOT be resolved as it's a sibling directory, not within the metadata path
            expect(resolvePath('/Users/steve/Develop/samsam-oo/unhappy-server/sources/types/index.ts', metadata))
                .toBe('/Users/steve/Develop/samsam-oo/unhappy-server/sources/types/index.ts');
        });
