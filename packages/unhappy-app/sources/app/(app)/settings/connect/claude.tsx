...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="unhappy connect claude" />
            {/* <OAuthView
                name="Claude"
                command="unhappy connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `unhappy connect ${props.name.toLowerCase()}`;
