...
Unhappy Coder is the secure mobile companion for Claude Code that lets you continue your AI coding sessions anywhere (not affiliated with Anthropic). Built by developers who needed to check on Claude's progress during coffee breaks, this app brings the full Claude Code experience to your phone with military-grade encryption.
We respectfully acknowledge slopus/happy as the original licensed upstream work and preserve attribution to that foundation.

**Important**: This app requires Claude Code to be installed on your computer. Unhappy Coder is a companion app that connects to your existing Claude Code setup.
...
Unhappy Coder uses the same encryption as Signal (TweetNaCl) and is completely open source. Your encryption keys never leave your device, and all data is encrypted before transmission.
