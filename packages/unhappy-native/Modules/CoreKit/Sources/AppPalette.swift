...
public enum AppPalette {
    ...
    public static let chatBackgroundTop = Color(red: 0.96, green: 0.97, blue: 1.00)
    public static let chatBackgroundBottom = Color(red: 0.99, green: 0.99, blue: 1.00)
    public static let chatUserBubble = accent.opacity(0.18)
    public static let chatAgentBubble = Color.primary.opacity(0.06)
    public static let chatBubbleStroke = Color.primary.opacity(0.12)
    public static let chatToolBackground = Color.primary.opacity(0.055)
