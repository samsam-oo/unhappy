...
@MainActor
struct SessionInfoToolOperationsSections: View {
        ...
        Section("Execution Mode") {
            Picker("Target", selection: $viewModel.switchTarget) {
                ForEach(APISessionSwitchTarget.allCases, id: \.self) { target in
                    Text(switchTargetLabel(target)).tag(target)
                }
            }
    ...
    private func permissionDecisionLabel(_ value: APISessionPermissionDecision) -> String {
        switch value {
        case .approved:
            return "Approve"
    ...
    private func permissionModeLabel(_ value: APISessionPermissionMode) -> String {
        switch value {
        case .default:
            return "Default"
        case .acceptEdits:
    ...
    private func switchTargetLabel(_ value: APISessionSwitchTarget) -> String {
        switch value {
        case .remote:
            return "Remote"
        case .local:
