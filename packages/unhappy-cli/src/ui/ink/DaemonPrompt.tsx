    ...
    <Box flexDirection="column">
      <Box marginBottom={1}>
        <Text bold color="cyan">
          🚀 Unhappy Daemon Setup
        </Text>
      </Box>

      <Box flexDirection="column" marginBottom={1}>
        <Text>📱 Unhappy can run a background service that allows you to:</Text>
        <Text color="cyan"> • Spawn new conversations from your phone</Text>
        <Text color="cyan"> • Continue closed conversations remotely</Text>
        <Text color="cyan">
          {' '}
          • Work with Claude while your computer has internet
        </Text>
      </Box>

      <Box marginBottom={1}>
        <Text>Would you like Unhappy to start this service automatically?</Text>
      </Box>
