...
describe('Api server error handling', () => {
  ...
  describe('getOrCreateSession', () => {
    it('should return null when Unhappy server is unreachable (ECONNREFUSED)', async () => {
    ...
    it('should return null when Unhappy server cannot be found (ENOTFOUND)', async () => {
    ...
    it('should return null when Unhappy server times out (ETIMEDOUT)', async () => {
      connectionState.reset();
      const consoleSpy = vi.spyOn(console, 'log').mockImplementation(() => {});
