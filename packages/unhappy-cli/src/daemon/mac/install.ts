/**
 * Installation script for Unhappy daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the unhappy command. 
 * 
 ...
 * 2. We assume users will run unhappy frequently (every time they open their laptop)
    ...
    try {
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <string>${os.homedir()}/.unhappy/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.unhappy/daemon.log</string>
        ...
        logger.info('Check logs at ~/.unhappy/daemon.log');
