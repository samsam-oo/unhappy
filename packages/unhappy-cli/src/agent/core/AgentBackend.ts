 ...
 * the Unhappy CLI and mobile app.
 *
 ...
 * These messages are forwarded to the Unhappy server and mobile app.
 */
export type AgentMessage =
  ...
  | {
    ...
    } // Patch operation begin (like Codex patch_apply_begin)
  | {
      ...
      stderr?: string;
      success: boolean;
    }; // Patch operation end (like Codex patch_apply_end)
 ...
 * this interface to be usable through the Unhappy CLI and mobile app.
 */
